...
module.exports = {
  ...
  sum(...amount) {
    ...
    if (amountList.length === 1) {
      if (Array.isArray(amountList[0])) return module.exports.sum(...amountList[0]);
  ...
  isZero: (amount) => module.exports.value(amount) === 0,
  isPositive: (amount) => module.exports.value(amount) > 0,
  isNegative: (amount) => module.exports.value(amount) < 0,
  abs: (amount, decimals = 2) => Math.abs(module.exports.value(amount, decimals)),
  min: (...amounts) => {
    const vals = amounts.flat().map((a) => module.exports.value(a));
